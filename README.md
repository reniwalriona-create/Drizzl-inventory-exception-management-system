...
It creates and drops a throwaway PostgreSQL database and runs the six files through the real staging, source-assignment, posting, classification, ledger, lookup, and reporting services.
