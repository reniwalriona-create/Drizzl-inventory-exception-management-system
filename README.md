...
> This portfolio case study uses fictional identifiers, synthetic documents, and sanitized screenshots. It discusses Drizzl's operating workflow without exposing production records or private company materials.

[**Watch the 2:27 demo walkthrough →**](https://youtu.be/jKcDjJRn7pU)

[Read the technical documentation](TECHNICAL_README.md) · [Read the short case study](case-study/CASE_STUDY_SHORT.md)
...
I owned the project end to end: problem framing, requirements, business rules, workflow and data design, UX, implementation, testing, and deployment. A Drizzl cofounder and the employee responsible for inventory and fulfillment supplied operational knowledge and reviewed the evolving workflow; I remained responsible for the product and implementation decisions. I used AI-assisted development tools during implementation while retaining responsibility for the architecture, business logic, validation, and final output.
...
| August 22–26: verification and deployment | End-to-end testing, workflow refinement, demo video, guided user walkthrough, and production deployment |
...
![Staged purchase-order batch showing validation status before posting](case-study/assets/04-po-review.png)
...
![PO review showing the assigned Drizzl source warehouse](case-study/assets/05-source-warehouse.png)
...
![Inventory dashboard populated from ledger movements](case-study/assets/01-inventory-dashboard.png)

*Location balances are calculated from the movement ledger rather than maintained as editable totals.*

![Manual movement form showing the supported movement types](case-study/assets/02-movement-types.png)

*The manual workflow captures operational events that do not have PO or GRN paperwork.*

![Movement form creating a new inventory location](case-study/assets/03-add-location.png)
...
![PO–GRN–discrepancy tracker showing connected fulfillment states](case-study/assets/07-fulfillment-tracker.png)

*The tracker replaces manual document matching with one view of commitments, receipts, shortfalls, and discrepancy status.*

![Combined lookup connecting a PO to its GRN and quantity comparison](case-study/assets/10-document-lookup.png)
...
![GRN review showing ordered, received, and discrepancy quantities](case-study/assets/06-grn-review.png)

*The GRN is verified against its PO before the sale and any shortfall are posted to the ledger.*

![GRN detail with its attached discrepancy classification](case-study/assets/08-attached-discrepancy.png)

*The discrepancy explains an existing shortfall by product and cause without deducting inventory again.*

![Debits and Losses report summarizing classified exceptions](case-study/assets/09-debits-and-losses.png)
...
![Movement history showing the void and restore controls](case-study/assets/12-void-and-restore.png)
...
![Activity log showing user-attributed operational actions](case-study/assets/11-activity-log.png)
...
![Stock visualization by product and location](case-study/assets/13-stock-visualizations.png)
